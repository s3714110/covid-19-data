...
`3/117` scripts failed, `10/117` were skipped. Latest update was `2022-04-28T07:06:09`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>❌</td>
      <td>2022-04-28T07:06:09</td>
      <td>78.86</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 47, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 177, in main<br>    PAHO().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 172, in export<br>    df = self.read().pipe(self.pipeline)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 147, in pipeline<br>    df.pipe(self.pipe_check_columns)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 138, in pipe_vaccine<br>    vaccine=df_who.vaccine.apply(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/series.py", line 4357, in apply<br>    return SeriesApply(self, func, convert_dtype, args, kwargs).apply()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/apply.py", line 1043, in apply<br>    return self.apply_standard()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/apply.py", line 1098, in apply_standard<br>    mapped = lib.map_infer(<br>  File "pandas/_libs/lib.pyx", line 2859, in pandas._libs.lib.map_infer<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 139, in <lambda><br>    lambda x: ", ".join(sorted(set(WHO_VACCINES[xx.strip()] for xx in x.split(","))))<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/paho.py", line 139, in <genexpr><br>    lambda x: ", ".join(sorted(set(WHO_VACCINES[xx.strip()] for xx in x.split(","))))<br>KeyError: 'Unknown Vaccine'<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.lebanon</td>
      <td>❌</td>
      <td>2022-04-28T07:04:50</td>
      <td>0.39</td>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-04-28T07:03:21</td>
      <td>0.10</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 47, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/chile.py", line 123, in main<br>    Chile().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/chile.py", line 108, in export<br>    df_man = self.read(self.source_url_manufacturer).pipe(self.pipeline_manufacturer)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/chile.py", line 96, in pipeline_manufacturer<br>    df.pipe(self.pipe_melt, ["Fabricante", "Dosis"])<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/chile.py", line 85, in pipe_rename_vaccines<br>    raise ValueError(f"Missing vaccines: {vaccines_wrong}")<br>ValueError: Missing vaccines: {'Moderna'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.vietnam</td>
      <td>⚠️</td>
      <td>2022-04-28T07:02:32</td>
      <td>NaN</td>
      <td></td>
    </tr>
    <tr>
...
`4/223` processes failed, `0/223` were skipped. Latest update was `2022-04-28T07:06:30`.
