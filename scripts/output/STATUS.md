...
`10/111` scripts failed, `23/111` were skipped. Latest update was `2022-10-18T07:16:24`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-10-18T07:08:09</td>
      <td>122.19</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/dominican_republic.py", line 112, in main<br>    DominicanRepublic().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/dominican_republic.py", line 68, in export<br>    data = self.read().pipe(self.pipeline)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/dominican_republic.py", line 23, in read<br>    with webdriver.Chrome(options=op) as driver:<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/selenium/webdriver/chrome/webdriver.py", line 76, in __init__<br>    RemoteWebDriver.__init__(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/selenium/webdriver/remote/webdriver.py", line 157, in __init__<br>    self.start_session(capabilities, browser_profile)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/selenium/webdriver/remote/webdriver.py", line 252, in start_session<br>    response = self.execute(Command.NEW_SESSION, parameters)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/selenium/webdriver/remote/webdriver.py", line 321, in execute<br>    self.error_handler.check_response(response)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/selenium/webdriver/remote/errorhandler.py", line 242, in check_response<br>    raise exception_class(message, screen, stacktrace)<br>selenium.common.exceptions.WebDriverException: Message: unknown error: DevToolsActivePort file doesn't exist<br><br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.canada</td>
      <td>❌</td>
      <td>2022-10-18T07:06:06</td>
      <td>7.58</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 276, in main<br>    Canada().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 263, in export<br>    df_man = df_man.pipe(self.pipeline_manufacturer)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 189, in pipeline_manufacturer<br>    validate_vaccines(df, self.vaccine_mapping)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 261, in validate_vaccines<br>    raise ValueError(f"Missing vaccines: {vaccines_wrong}")<br>ValueError: Missing vaccines: {'Moderna Spikevax Bivalent'}<br></pre></details></td>
    </tr>
    <tr>
...
`6/223` processes failed, `0/223` were skipped. Latest update was `2022-10-18T07:16:49`.
