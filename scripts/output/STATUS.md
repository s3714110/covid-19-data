...
`9/111` scripts failed, `27/111` were skipped. Latest update was `2023-01-29T07:08:21`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2023-01-29T07:04:53</td>
      <td>58.37</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/incremental/china.py", line 186, in main<br>    China().export()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/incremental/china.py", line 174, in export<br>    df_complete = self.read_complete()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/incremental/china.py", line 90, in read_complete<br>    data_ = self._parse_data_complete(driver, link)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/incremental/china.py", line 128, in _parse_data_complete<br>    raise ValueError("No date could be found!")<br>ValueError: No date could be found!<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.latvia</td>
      <td>❌</td>
      <td>2023-01-29T07:03:54</td>
      <td>13.50</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/latvia.py", line 180, in main<br>    Latvia().export()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/latvia.py", line 164, in export<br>    df = self.from_ice()  # temporary<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/utils/base.py", line 63, in from_ice<br>    _check_last_update(path, self.location)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/utils/base.py", line 386, in _check_last_update<br>    metadata = S3().get_metadata(path)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/utils/s3.py", line 168, in get_metadata<br>    response = self.client.head_object(Bucket=bucket_name, Key=s3_file)<br>  File "/home/owid/covid-19-data/scripts/venv/lib/python3.10/site-packages/botocore/client.py", line 388, in _api_call<br>    return self._make_api_call(operation_name, kwargs)<br>  File "/home/owid/covid-19-data/scripts/venv/lib/python3.10/site-packages/botocore/client.py", line 708, in _make_api_call<br>    raise error_class(parsed_response, operation_name)<br>botocore.exceptions.ClientError: An error occurred (503) when calling the HeadObject operation (reached max retries: 4): Service Unavailable<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.hong_kong</td>
      <td>❌</td>
      <td>2023-01-29T07:03:41</td>
      <td>2.58</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/hong_kong.py", line 214, in main<br>    HongKong().export()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/hong_kong.py", line 196, in export<br>    self.check_number_age_groups_latest(df_base)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/hong_kong.py", line 191, in check_number_age_groups_latest<br>    raise ValueError(f"Missing age groups! Check dates {wrong_rows.index.tolist()}")<br>ValueError: Missing age groups! Check dates ['2023-01-22']<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.canada</td>
      <td>❌</td>
      <td>2023-01-29T07:03:38</td>
      <td>6.93</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 282, in main<br>    Canada().export()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 266, in export<br>    df, df_age, df_man = self.read(), self.read_age(), self.read_manufacturer()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 103, in read_age<br>    check_known_columns(<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/utils/utils.py", line 164, in check_known_columns<br>    raise Exception(f"Unknown column(s) found: {unknown_cols}")<br>Exception: Unknown column(s) found: {'Unnamed: 19', 'Unnamed: 22', 'Unnamed: 21', 'Unnamed: 24', 'Unnamed: 18', 'Unnamed: 20', 'Unnamed: 23'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.united_arab_emirates</td>
      <td>⚠️</td>
      <td>2023-01-29T07:00:29</td>
      <td>NaN</td>
      <td></td>
    </tr>
    <tr>
...
`2/223` processes failed, `0/223` were skipped. Latest update was `2023-01-29T07:08:33`.
