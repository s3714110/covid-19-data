...
`2/111` scripts failed, `18/111` were skipped. Latest update was `2022-08-13T07:06:23`.
...
`9/223` processes failed, `0/223` were skipped. Latest update was `2022-08-13T07:06:48`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>Macao</td>
      <td>❌</td>
      <td>2022-08-13T07:06:39</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 69, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 249, in run<br>    self.check_metrics()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 166, in check_metrics<br>    self._check_metrics_monotonic(df)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 182, in _check_metrics_monotonic<br>    raise ValueError(<br>ValueError: Macao -- Column people_fully_vaccinated must be monotonically increasing! Check:<br>    location       date  ... people_fully_vaccinated total_boosters<br>400    Macao 2022-08-11  ...                  589384         289133<br>401    Macao 2022-08-12  ...                  589259         289557<br><br>[2 rows x 8 columns]<br></pre></details></td>
    </tr>
    <tr>
      <td>Ghana</td>
      <td>❌</td>
      <td>2022-08-13T07:06:35</td>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-08-13T07:06:29</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 69, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 249, in run<br>    self.check_metrics()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 168, in check_metrics<br>    self._check_metrics_inequalities(df)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 206, in _check_metrics_inequalities<br>    raise ValueError(<br>ValueError: Antigua and Barbuda -- people_vaccinated can't be < people_fully_vaccinated!<br>               location       date  ... people_fully_vaccinated total_boosters<br>93  Antigua and Barbuda 2022-08-06  ...                   64176           <NA><br><br>[1 rows x 8 columns]<br></pre></details></td>
    </tr>
    <tr>
      <td>Venezuela</td>
      <td>✅</td>
      <td>2022-08-13T07:06:48</td>
      <td></td>
    </tr>
    <tr>
      <td>Vietnam</td>
