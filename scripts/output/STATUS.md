...
`2/111` scripts failed, `18/111` were skipped. Latest update was `2022-08-26T07:05:02`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-08-26T07:04:10</td>
      <td>4.54</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 47, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/austria.py", line 123, in main<br>    Austria().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/austria.py", line 118, in export<br>    df = self.read().pipe(self.pipeline)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/austria.py", line 106, in pipeline<br>    df.pipe(self.pipe_filter_rows)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/base.py", line 306, in pipe_check_vaccine<br>    self.check_column_values(df, "vaccine", vaccines_accepted)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/base.py", line 313, in check_column_values<br>    raise ValueError(f"Found unknown values for `{col_name}`: {unknown_vaccines}")<br>ValueError: Found unknown values for `vaccine`: {'VALNEVA'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.united_arab_emirates</td>
      <td>⚠️</td>
      <td>2022-08-26T07:03:49</td>
      <td>NaN</td>
      <td></td>
    </tr>
    <tr>
...
`1/223` processes failed, `0/223` were skipped. Latest update was `2022-08-26T07:05:33`.
