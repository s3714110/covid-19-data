...
`6/111` scripts failed, `19/111` were skipped. Latest update was `2022-07-26T07:04:43`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>❌</td>
      <td>2022-07-26T07:04:43</td>
      <td>3.17</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 47, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/cuba.py", line 73, in main<br>    Cuba().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/cuba.py", line 59, in export<br>    data = self.read().pipe(self.pipeline)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/cuba.py", line 25, in read<br>    return self._parse_data(soup)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/cuba.py", line 30, in _parse_data<br>    "date": self._parse_date(soup),<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/incremental/cuba.py", line 37, in _parse_date<br>    date_str = match.group(1)<br>AttributeError: 'NoneType' object has no attribute 'group'<br></pre></details></td>
    </tr>
    <tr>
...
`9/223` processes failed, `0/223` were skipped. Latest update was `2022-07-26T07:05:10`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>Kyrgyzstan</td>
      <td>❌</td>
      <td>2022-07-26T07:04:59</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 68, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 248, in run<br>    self.check_metrics()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 165, in check_metrics<br>    self._check_metrics_monotonic(df)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 181, in _check_metrics_monotonic<br>    raise ValueError(<br>ValueError: Kyrgyzstan -- Column people_vaccinated must be monotonically increasing! Check:<br>       location       date  ... people_fully_vaccinated total_boosters<br>352  Kyrgyzstan 2022-07-25  ...                 1326878           <NA><br><br>[1 rows x 8 columns]<br></pre></details></td>
    </tr>
    <tr>
      <td>Jamaica</td>
      <td>❌</td>
      <td>2022-07-26T07:04:58</td>
