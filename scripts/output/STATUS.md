...
`2/111` scripts failed, `16/111` were skipped. Latest update was `2022-06-28T07:05:31`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-06-28T07:03:16</td>
      <td>6.16</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 47, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 248, in main<br>    Canada().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 232, in export<br>    df, df_age, df_man = self.read(), self.read_age(), self.read_manufacturer()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/canada.py", line 116, in read_manufacturer<br>    check_known_columns(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/utils/utils.py", line 164, in check_known_columns<br>    raise Exception(f"Unknown column(s) found: {unknown_cols}")<br>Exception: Unknown column(s) found: {'num4weekdelta_notreported', 'num4weekdelta_dose1', 'num4weekdelta_dose5+', 'num4weekdelta_dose4', 'num4weekdelta_dose3', 'numtotal_dosenotreported_admin', 'num2weekdelta_notreported', 'numdelta_notreported', 'num4weekdelta_dose2'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.united_arab_emirates</td>
      <td>⚠️</td>
      <td>2022-06-28T07:02:54</td>
      <td>NaN</td>
      <td></td>
    </tr>
    <tr>
...
`2/223` processes failed, `0/223` were skipped. Latest update was `2022-06-28T07:05:50`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>Fiji</td>
      <td>❌</td>
      <td>2022-06-28T07:05:40</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 68, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 248, in run<br>    self.check_metrics()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 165, in check_metrics<br>    self._check_metrics_monotonic(df)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 181, in _check_metrics_monotonic<br>    raise ValueError(<br>ValueError: Fiji -- Column total_vaccinations must be monotonically increasing! Check:<br>   location       date  ... people_fully_vaccinated total_boosters<br>60     Fiji 2022-06-27  ...                  635168           <NA><br><br>[1 rows x 8 columns]<br></pre></details></td>
    </tr>
    <tr>
      <td>United Kingdom</td>
      <td>✅</td>
      <td>2022-06-28T07:05:50</td>
      <td></td>
    </tr>
    <tr>
      <td>United States</td>
