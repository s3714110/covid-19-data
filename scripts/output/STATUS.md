...
`6/119` scripts failed, `10/119` were skipped. Latest update was `2022-04-06T10:17:52`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>4.34</td>
      <td><details><summary>show</summary><pre>Unknown column(s) found: {'Series_Complete_Pop_Pct', 'Additional_Doses_Vax_Pct', 'Administered_Dose1_Pop_Pct\u200b'}</pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.pakistan</td>
      <td>❌</td>
      <td>0.91</td>
      <td><details><summary>show</summary><pre>HTTPSConnectionPool(host='covid.gov.pkcovid-vaccination-en.php', port=443): Max retries exceeded with url: / (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x7fd1d8700520>: Failed to establish a new connection: [Errno -2] Name or service not known'))</pre></details></td>
    </tr>
    <tr>
