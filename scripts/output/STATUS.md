...
`4/111` scripts failed, `24/111` were skipped. Latest update was `2022-12-07T07:08:24`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-12-07T07:03:47</td>
      <td>1.19</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/denmark.py", line 244, in main<br>    Denmark().export()<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/denmark.py", line 225, in export<br>    df = self.read(index).pipe(self.pipeline, df_current).pipe(self.make_monotonic)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/denmark.py", line 47, in read<br>    df = self._load_data(tf)<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/denmark.py", line 59, in _load_data<br>    df_ss = pd.DataFrame([self._read_single_shots_daily(path)])<br>  File "/home/owid/covid-19-data/scripts/src/cowidev/vax/batch/denmark.py", line 123, in _read_single_shots_daily<br>    raise ValueError(f"Unknown vaccine(s) {vaccines_wrong}")<br>ValueError: Unknown vaccine(s) {'Uspecificeret'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.incremental.united_arab_emirates</td>
      <td>⚠️</td>
      <td>2022-12-07T07:00:33</td>
      <td>NaN</td>
      <td></td>
    </tr>
    <tr>
...
`4/223` processes failed, `0/223` were skipped. Latest update was `2022-12-07T07:08:35`.
