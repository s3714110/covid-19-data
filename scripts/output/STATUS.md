...
`4/111` scripts failed, `23/111` were skipped. Latest update was `2022-10-05T07:03:46`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-10-05T07:03:26</td>
      <td>1.00</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 258, in main<br>    Switzerland().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 230, in export<br>    df, df_manuf, df_age = self.read()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 27, in read<br>    df, df_manufacturer = self._parse_data(doses_url, people_url, manufacturer_url)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 71, in _parse_data<br>    assert set(people.type) == accepted_types, "New type found! Check people.type"<br>AssertionError: New type found! Check people.type<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.japan</td>
      <td>❌</td>
      <td>2022-10-05T07:03:25</td>
      <td>0.47</td>
...
`6/223` processes failed, `0/223` were skipped. Latest update was `2022-10-05T07:04:13`.
