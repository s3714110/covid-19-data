...
`9/112` scripts failed, `23/112` were skipped. Latest update was `2022-10-19T07:06:10`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>❌</td>
      <td>2022-10-19T07:04:22</td>
      <td>5.07</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 264, in main<br>    Switzerland().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 247, in export<br>    df_manuf = df_manuf.pipe(self.pipeline_manufacturer)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/generic.py", line 5430, in pipe<br>    return com.pipe(self, func, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/core/common.py", line 471, in pipe<br>    return func(obj, *args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/switzerland.py", line 156, in pipeline_manufacturer<br>    validate_vaccines(df, self.vaccine_mapping)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 261, in validate_vaccines<br>    raise ValueError(f"Missing vaccines: {vaccines_wrong}")<br>ValueError: Missing vaccines: {'pfizer_biontech_bivalent'}<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.new_zealand</td>
      <td>❌</td>
      <td>2022-10-19T07:04:17</td>
      <td>5.61</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/commons/get.py", line 46, in run<br>    module.main()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/new_zealand.py", line 116, in main<br>    NewZealand().export()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/new_zealand.py", line 111, in export<br>    df = self.read().pipe(self.pipeline)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/batch/new_zealand.py", line 43, in read<br>    df = read_xlsx_from_url(link, sheet_name="Date")<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/utils/web/download.py", line 45, in read_xlsx_from_url<br>    df = pd.read_excel(tmp.name, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/util/_decorators.py", line 311, in wrapper<br>    return func(*args, **kwargs)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/io/excel/_base.py", line 364, in read_excel<br>    io = ExcelFile(io, storage_options=storage_options, engine=engine)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/venv/lib/python3.9/site-packages/pandas/io/excel/_base.py", line 1195, in __init__<br>    raise ValueError(<br>ValueError: Excel file format cannot be determined, you must specify an engine manually.<br></pre></details></td>
    </tr>
    <tr>
      <td>cowidev.vax.batch.japan</td>
      <td>❌</td>
      <td>2022-10-19T07:04:11</td>
      <td>0.31</td>
...
`8/223` processes failed, `0/223` were skipped. Latest update was `2022-10-19T07:06:36`.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>Switzerland</td>
      <td>❌</td>
      <td>2022-10-19T07:06:33</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 72, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 246, in run<br>    self.check_vaccine()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 145, in check_vaccine<br>    raise ValueError(f"{self.location} -- Invalid vaccine detected! Check {vaccines_wrong}.")<br>ValueError: Switzerland -- Invalid vaccine detected! Check ['pfizer_biontech_bivalent'].<br></pre></details></td>
    </tr>
    <tr>
      <td>Seychelles</td>
      <td>❌</td>
      <td>2022-10-19T07:06:32</td>
    ...
    <tr>
      <td>Liechtenstein</td>
      <td>❌</td>
      <td>2022-10-19T07:06:26</td>
      <td><details><summary>show</summary><pre>Traceback (most recent call last):<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/process.py", line 95, in _process_location_and_move_file<br>    df = process_location(df, monotonic_check_skip, anomaly_check_skip)<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/cmd/vax/process/utils.py", line 57, in process_location<br>    country_df_sanity_checks(<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 72, in country_df_sanity_checks<br>    checker.run()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 246, in run<br>    self.check_vaccine()<br>  File "/mnt/owid_live_covid/covid-19-data/scripts/src/cowidev/vax/utils/checks.py", line 145, in check_vaccine<br>    raise ValueError(f"{self.location} -- Invalid vaccine detected! Check {vaccines_wrong}.")<br>ValueError: Liechtenstein -- Invalid vaccine detected! Check ['pfizer_biontech_bivalent'].<br></pre></details></td>
    </tr>
    <tr>
      <td>Jersey</td>
      <td>❌</td>
      <td>2022-10-19T07:06:25</td>
